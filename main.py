...
for x in xrange(1,18):
	...
	cmd ="mzn2fzn -I mznlib model/fg-domain.mzn "+testMap+" "+testIst+" -o xxx.fzn"
	print cmd
	...
	if isSuccess:
		...
		if isSuccess:
			...
			cmd = "mzn2fzn -I mznlib model/fg-vnf.mzn "+outfilename+" "+testIst+" -o yyy.fzn"
			print cmd
			compileinfo = os.popen(cmd).read() 
